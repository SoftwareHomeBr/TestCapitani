    ...
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration)
        {
            var pess= new PessoaVO[] {
                ...
                new PessoaVO{ PessoaId=3, Nome="Ana Furatdo", EstadoCivil=PessoaVO.ESTADO_CIVIL.PESSOA_SOLTEIRA, DataNascimento= randDates(), ParceiroId =0 },
                ...
                new PessoaVO{ PessoaId=10, Nome="Antonio Abujanra", EstadoCivil=PessoaVO.ESTADO_CIVIL.PESSOA_SOLTEIRA, DataNascimento= randDates(), ParceiroId =0 },
